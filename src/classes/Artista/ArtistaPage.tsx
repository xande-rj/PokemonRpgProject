...
const ArtistaPage = () => {
    return (
        ...
        <div className="container">
        <Link to="/classes/info/estilista" className="box box-1" data-text="Estilista" style={{ backgroundImage: "url(https://cdn.donmai.us/original/95/97/95970f30cbf59624e41d2aafe657c9b2.jpg)" }}></Link>
        <Link to="/classes/info/nerd" className="box box-2" data-text="Nerd" style={{ backgroundImage: "url(https://safebooru.org//images/4031/49fb10a884acfa7a8261353c8c59bd9d2e1b3268.png?4211829)" }}></Link>
        <Link to="/classes/info/parrudo" className="box box-3" data-text="Parrudo" style={{ backgroundImage: "url(https://pt.quizur.com/_image?href=https%3A%2F%2Fimg.quizur.com%2Ff%2Fimg5ec6bcedac7db5.86656041.png%3FlastEdited%3D1590082815&w=400&h=400&f=webp)" }}></Link>
        </div>
        </>
    );
}
