...
const CaptorPage = () => {
    return (
        <>
            ...
            <Link to="/classes/info/ladrão" className="box box-6" data-text="Ladrão" style={{ backgroundImage: "url(https://images.squarespace-cdn.com/content/v1/5cf4cfa4382ac0000123aa1b/c962ef2a-44d4-4054-bf2d-cf58ab2c9cb8/RSA+Thumbnail.jpg)" }}></Link>
            <Link to="/classes/info/malabarista" className="box box-7" data-text="Malabarista" style={{ backgroundImage: "url(https://pturpg.wdfiles.com/local--files/juggler/juggler.jpg)" }}></Link>
            <Link to="/classes/info/pokébolista" className="box box-8" data-text="Pokébolista" style={{ backgroundImage: "url(https://assets.mycast.io/characters/kurt-2645721-normal.jpg?1621483956)" }}></Link>
            </div>
