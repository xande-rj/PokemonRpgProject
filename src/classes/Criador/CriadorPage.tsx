...
const CriadorPage = () => {
    return (
        ...
        <div className="container">
        <Link to="/classes/info/incubador" className="box box-1" data-text="Incubador" style={{ backgroundImage: "url(https://i.pinimg.com/736x/0a/55/07/0a5507ca2be1fa9ee32b5088768e4e21.jpg)" }}></Link>
        <Link to="/classes/info/médico" className="box box-2" data-text="Médico" style={{ backgroundImage: "url(https://bracketfights.com/images/templates/2019/99452/pokegirls-99452/doctorftcgpng.png)" }}></Link>
        <Link to="/classes/info/tutor" className="box box-3" data-text="Tutor" style={{ backgroundImage: "url(https://pbs.twimg.com/media/EJBZNxfU8AIf2cb.jpg)" }}></Link>
        </div>
        </>
    );
}
