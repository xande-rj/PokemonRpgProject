...
const GuerreiroPage = () => {
    return (
        <>
             <MenuPage name="Classes Guerreiro"/>
            <div className="container">
                ...
                <Link to="/classes/info/monge" className="box box-6" data-text="Monge" style={{ backgroundImage: "url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSi-kRjPNNFT0fq_xzYLGm4Lp-JKouss_pTv1OB5sR2iG44qHcbd_or49h-nsCqfZv_QXI&usqp=CAU)" }}></Link>
                <Link to="/classes/info/ninja" className="box box-7" data-text="Ninja" style={{ backgroundImage: "url(https://i-ogp.pximg.net/c/540x540_70/img-master/img/2019/05/25/17/29/06/74895659_p0_square1200.jpg)" }}></Link>
                <Link to="/classes/info/soldado" className="box box-8" data-text="Soldado" style={{ backgroundImage: "url(https://pturpg.wdfiles.com/local--files/104:soldier/soldier.jpg)" }}></Link>
            </div>
        </>
    );
}
