...
const MísticoPage = () => {
    return (
        <>
            ...
            <div className="container">
                <Link to="/classes/info/orador" className="box box-1" data-text="Orador" style={{ backgroundImage: "url(https://m.media-amazon.com/images/M/MV5BOTc3Y2EzMDQtZWM1Yi00ZWYzLWJiNDYtNGMwNDBmMWUyYWU3XkEyXkFqcGc@._V1_.jpg)" }}></Link>
                <Link to="/classes/info/runico" className="box box-2" data-text="Rúnico" style={{ backgroundImage: "url(https://m.media-amazon.com/images/M/MV5BZjVhMjIxNzAtZDg3My00MjZmLThjNDMtNGJhMjI5NDNiMzVhXkEyXkFqcGc@._V1_.jpg)" }}></Link>
                <Link to="/classes/info/xama" className="box box-3" data-text="Xamã" style={{ backgroundImage: "url(https://artfiles.alphacoders.com/153/thumb-153147.png)" }}></Link>
            </div>
        </>
    );
}
