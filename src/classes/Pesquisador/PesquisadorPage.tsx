...
const PesquisadorPage = () => {
    return (
        <>
            ...
            <div className="container">
                <Link to="/classes/info/ocultista" className="box box-1" data-text="Ocultista" style={{ backgroundImage: "url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqVhOnEymxXPnn9qJ660NhBhYDCb7ESiuE_g&s)" }}></Link>
                <Link to="/classes/info/petrologista" className="box box-2" data-text="Petrologista" style={{ backgroundImage: "url(https://i.pinimg.com/736x/2b/c9/7e/2bc97ef2b52a8944d0ed642964bba256.jpg)" }}></Link>
                <Link to="/classes/info/professor" className="box box-3" data-text="Professor" style={{ backgroundImage: "url(https://imgix.ranker.com/user_node_img/3683/73645741/original/73645741-photo-u2065045985?auto=format&q=60&fit=crop&fm=pjpg&dpr=2&w=355)" }}></Link>
            </div>
        </>
    );
}
