...
const PsíquicoPage = () => {
    return (
        <>
            ...
            <div className="container">
                <Link to="/classes/info/nebuloso" className="box box-1" data-text="Nebuloso" style={{ backgroundImage: "url(https://images6.fanpop.com/image/photos/34100000/Marlon-pokemon-marlon-34135257-500-495.jpg)" }}></Link>
                <Link to="/classes/info/terrulento" className="box box-2" data-text="Terrulento" style={{ backgroundImage: "url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhtMlEnWotoXkgcxhpZoK4-KhvNCyvWTcLhI8BprVlBPmi2H8VP-WOwTkNi43PdcLEfs7EHaimkbn5YP4VHSpPT4sWxVV5vvKVNo9jgVZ1eHsEVhZNW6j9W7KB3uQVtWg02COVls900Mhc/s16000-rw/800px-Young_Roark.jpg)" }}></Link>
                <Link to="/classes/info/vidente" className="box box-3" data-text="Vidente" style={{ backgroundImage: "url(https://images6.fanpop.com/image/photos/34100000/Caitlin-pokemon-caitlin-34182222-506-512.jpg)" }}></Link>
            </div>
        </>
    );
}
