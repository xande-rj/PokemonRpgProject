...
const RangerPage = () => {
    return (
        <>
            ...
            <div className="container">
                <Link to="/classes/info/oficial" className="box box-1" data-text="Oficial" style={{ backgroundImage: "url(https://i.ytimg.com/vi/doG_XmmbrgY/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLCfunc3L5KpLwn4VjClPuTzfo9New)" }}></Link>
                <Link to="/classes/info/pactuario" className="box box-2" data-text="Pactuário" style={{ backgroundImage: "url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiGB0ec8jowlRwg5E_hucr0thI5s8sWug5Xqw8AQ07CT20juvgtfQl2nZO2eaxm8hf4DaVVUwP0AnvZFxEq7e6ozK_t1EsgkqJ65aD2itb-sL8LOqro-N7afjct5yW_fTPaCdYOCaWGcm8/s610/Pokemon_Ranger_Guardian_Signs_Deoxys.png)" }}></Link>
                <Link to="/classes/info/policial" className="box box-3" data-text="Policial" style={{ backgroundImage: "url(https://cdn.donmai.us/original/97/ed/97edb34ff227caf81b2cde8629e39416.jpg)" }}></Link>
            </div>
        </>
    );
}
