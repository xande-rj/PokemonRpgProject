...
const TreinadorPage = () => {
    return (
        <>
           <MenuPage name="Classes Treinador"/>
            <div className="container">
                ...
                <Link to="/classes/info/estrategista" className="box box-6" data-text="Estrategista" style={{ backgroundImage: "url(https://artfiles.alphacoders.com/136/136127.png)" }}></Link>
                <Link to="/classes/info/inquebravel" className="box box-7" data-text="Inquebrável" style={{ backgroundImage: "url(https://preview.redd.it/ok-i-dont-hate-horizons-but-im-starting-to-get-a-bit-v0-rirp47o6sx0c1.jpg?auto=webp&s=400f83fb75df4d421dbab6fc960447f5088605fd)" }}></Link>
                <Link to="/classes/info/sincrono" className="box box-8" data-text="Síncrono" style={{ backgroundImage: "url(https://64.media.tumblr.com/283af1d1beb844bf1d0eaab4f5eb9a44/015f083459ca836d-b6/s1280x1920/0aa163df7ad680e4a98a6d5c131e4963d41f6ec0.jpg)" }}></Link>
            </div>
        </>
    );
}
